...
@section('content')
    ...
    <div class="main-content">
        <div class="row"><!-- row -->
            ...
            <!-- service -->
            <div class="col-md-4 spaceup spacedown animfadeInUp" data-time="900">
                <i class="fa fa-desktop fa-4x spaceicon"></i>
                <h4>Responsive Design</h4>
                <p>Responsive Design in all devices.</p>
            </div>
            <div class="col-md-4 spaceup spacedown animfadeInUp" data-time="1200">
                <i class="fa fa-cloud fa-4x spaceicon"></i>
                <h4>Full screen popup</h4>
                <p>Popup used to display content inside</p>
            </div>
            <div class="col-md-4 spaceup spacedown animfadeInUp" data-time="1500">
                <i class="fa fa-cog fa-4x spaceicon"></i>
                <h4>UX Design</h4>
                <p>UX design website for user experience </p>
            </div>
            <!-- service end -->
